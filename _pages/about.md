...
* He has several opensource projects on Github, including [MASS](https://github.com/microsoft/mass), MPNet([Huggingface](https://huggingface.co/transformers/model_doc/mpnet.html)), [Muzic](https://github.com/microsoft/muzic), [NeuralSpeech](https://github.com/microsoft/NeuralSpeech).
